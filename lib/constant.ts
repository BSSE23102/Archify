...
/** sessionStorage key prefix for upload payload before visualizer loads */
export const VISUALIZER_SESSION_PREFIX = "archify:viz:";

export function visualizerSessionKey(id: string) {
  return `${VISUALIZER_SESSION_PREFIX}${id}`;
}
